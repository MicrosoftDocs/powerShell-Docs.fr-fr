...
|-|-
| Configurations partielles | [Documentation](partialconfigs.md)
| Ressources composites | [Documentation](authoringresourcecomposite.md)
...
Pour plus d’informations sur l’utilisation des pipelines de mise en production pour gérer l’infrastructure de base, consultez le livre blanc [The Release Pipeline Model](http://aka.ms/thereleasepipelinemodel).
