...
> **Remarque** : Clés d’inscription ne sont pas pris en charge dans PowerShell 4.0.
...
> **Remarque** : Le **ReportServerWeb** section permet de générer des données à envoyer au serveur collecteur.
...
- [[MS-DSCPM] : Desired State Configuration de protocole de modèle Pull](https://msdn.microsoft.com/library/dn393548.aspx)
- [[MS-DSCPM] : Desired State Configuration Errata de modèle Pull](https://msdn.microsoft.com/library/mt612824.aspx)
