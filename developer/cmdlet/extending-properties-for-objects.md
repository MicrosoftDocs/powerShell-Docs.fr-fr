...
> [!NOTE]
> Les exemples des sections suivantes proviennent du fichier de types `Types.ps1xml` par défaut dans le répertoire d’installation de`$PSHOME`PowerShell (). Pour plus d’informations, consultez [à propos des types. ps1xml](/powershell/module/microsoft.powershell.core/about/about_types.ps1xml).
