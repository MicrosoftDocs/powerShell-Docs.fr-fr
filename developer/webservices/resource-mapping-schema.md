...
---
# <a name="resource-mapping-schema"></a>Schéma de mappage des ressources

Extension IIS Management OData utilise des fichiers XML pour définir le mappage des ressources. Le schéma XSD suivant définit le schéma utilisé pour ces fichiers.

## <a name="resource-mapping-file-xsd"></a>Fichier de mappage des ressources XSD

Le schéma XSD suivant définit le schéma pour les fichiers de mappage de ressource Extension IIS Management OData.
