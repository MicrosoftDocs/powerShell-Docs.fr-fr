...
ms.locfileid: "56862565"
---
# <a name="role-based-authorization-configuration-schema"></a><span data-ttu-id="482d4-102">Schéma de configuration des autorisations en fonction du rôle</span><span class="sxs-lookup"><span data-stu-id="482d4-102">Role-Based Authorization Configuration Schema</span></span>

<span data-ttu-id="482d4-103">Le [PswsRoleBasedPlugins](http://go.microsoft.com/fwlink/?LinkId=243041) exemple utilise des fichiers XML pour configurer la stratégie d’autorisation.</span><span class="sxs-lookup"><span data-stu-id="482d4-103">The [PswsRoleBasedPlugins](http://go.microsoft.com/fwlink/?LinkId=243041) sample uses XML files to configure the authorization policy.</span></span> <span data-ttu-id="482d4-104">Le schéma XSD suivant définit le schéma utilisé pour ces fichiers.</span><span class="sxs-lookup"><span data-stu-id="482d4-104">The following XSD defines the schema used for these files.</span></span>
