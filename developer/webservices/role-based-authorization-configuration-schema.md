---
title: Schéma de Configuration d’autorisation en fonction du rôle | Microsoft Docs
ms.custom: ''
ms.date: 09/12/2016
ms.reviewer: ''
ms.suite: ''
...
ms.locfileid: "62080541"
---
# <a name="role-based-authorization-configuration-schema"></a><span data-ttu-id="72e67-102">Schéma de configuration des autorisations en fonction du rôle</span><span class="sxs-lookup"><span data-stu-id="72e67-102">Role-Based Authorization Configuration Schema</span></span>

<span data-ttu-id="72e67-103">Le [PswsRoleBasedPlugins](http://go.microsoft.com/fwlink/?LinkId=243041) exemple utilise des fichiers XML pour configurer la stratégie d’autorisation.</span><span class="sxs-lookup"><span data-stu-id="72e67-103">The [PswsRoleBasedPlugins](http://go.microsoft.com/fwlink/?LinkId=243041) sample uses XML files to configure the authorization policy.</span></span> <span data-ttu-id="72e67-104">Le schéma XSD suivant définit le schéma utilisé pour ces fichiers.</span><span class="sxs-lookup"><span data-stu-id="72e67-104">The following XSD defines the schema used for these files.</span></span>
