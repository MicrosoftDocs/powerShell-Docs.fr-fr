...
---
# <a name="deploying-a-management-odata-web-service"></a>Déploiement d’un service web Management OData

Une fois que vous avez terminé toutes les étapes nécessaires pour créer un service web de gestion OData, vous devez le déployer comme une application web dans IIS.

## <a name="deploying-the-web-service"></a>Déploiement du service web

Effectuez les étapes suivantes pour déployer le service web de gestion OData.

1. Créez un répertoire pour votre application sous votre IIS `WWWRoot` directory.

2. Copiez le fichier de schéma MOF, le fichier de schéma XML, les DLL qui exportent le [Microsoft.Management.Odata.Customauthorization](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization) et [System.Management.Automation.Remoting.Pssessionconfiguration](/dotnet/api/System.Management.Automation.Remoting.PSSessionConfiguration) interfaces et le fichier web.config dans le répertoire de l’application.

3. Créer un code de site.

4. Créez et configurez un pool d’applications.

5. Configurer l’authentification pour le site.

6. Configurer le pare-feu.

7. Démarrer le site.

Les scripts Windows PowerShell suivants montrent comment déployer un service web de gestion OData.
