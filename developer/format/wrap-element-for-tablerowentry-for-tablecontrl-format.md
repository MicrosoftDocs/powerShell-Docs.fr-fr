...
---
# <a name="wrap-element-for-tablerowentry-for-tablecontrl--format"></a>Wrap, élément pour TableRowEntry pour TableControl (Format)
...
|Élément|Description|
|-------------|-----------------|
|[Élément TableRowEntry pour TabbleRowEntries pour TablControl (Format)](./tablerowentry-element-for-tablerowentroes-for-tablecontrol-format.md)|Définit les données qui s’affiche dans une ligne de la table.|
