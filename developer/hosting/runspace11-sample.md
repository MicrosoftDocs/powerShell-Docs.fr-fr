...
- Création d’un [System.Management.Automation.Commandmetadata](/dotnet/api/System.Management.Automation.CommandMetadata) objet qui décrit les métadonnées d’une cmdlet existante.
...
- Modifier les métadonnées de l’applet de commande pour supprimer un paramètre de l’applet de commande.

- Ajout de l’applet de commande pour le [System.Management.Automation.Runspaces.Initialsessionstate](/dotnet/api/System.Management.Automation.Runspaces.InitialSessionState) objet et effectue l’applet de commande privé.

- Création d’une fonction de proxy qui appelle l’applet de commande existante, mais expose uniquement un ensemble limité de paramètres.

- Ajout de la fonction de proxy à l’état de session initiale.
...
- Appel de l’applet de commande privé et la fonction de proxy à l’aide un [System.Management.Automation.Powershell](/dotnet/api/system.management.automation.powershell) objet afin d’illustrer l’instance d’exécution contrainte.

## <a name="example"></a>Exemple

Cette opération crée une commande de proxy pour une applet de commande privé illustrer une instance d’exécution contrainte.
