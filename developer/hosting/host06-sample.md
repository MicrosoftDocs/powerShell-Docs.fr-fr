---
title: Exemple de Host06 | Microsoft Docs
ms.custom: ''
ms.date: 09/13/2016
ms.reviewer: ''
ms.suite: ''
...
ms.locfileid: "56863685"
---
# <a name="host06-sample"></a><span data-ttu-id="480c9-102">Exemple Host06</span><span class="sxs-lookup"><span data-stu-id="480c9-102">Host06 Sample</span></span>

<span data-ttu-id="480c9-103">Cet exemple montre comment créer une application hôte console interactive qui lit les commandes à partir de la ligne de commande, exécute les commandes, puis affiche les résultats dans la console.</span><span class="sxs-lookup"><span data-stu-id="480c9-103">This sample shows how to build an interactive console-based host application that reads commands from the command line, executes the commands, and then displays the results to the console.</span></span> <span data-ttu-id="480c9-104">Par ailleurs, cet exemple utilise les API génératrices de jetons pour spécifier la couleur du texte entré par l’utilisateur.</span><span class="sxs-lookup"><span data-stu-id="480c9-104">In addition, this sample uses the Tokenizer APIs to specify the color of the text that is entered by the user.</span></span>

## <a name="requirements"></a><span data-ttu-id="480c9-105">Spécifications</span><span class="sxs-lookup"><span data-stu-id="480c9-105">Requirements</span></span>

- <span data-ttu-id="480c9-106">Cet exemple requiert Windows PowerShell 2.0.</span><span class="sxs-lookup"><span data-stu-id="480c9-106">This sample requires Windows PowerShell 2.0.</span></span>

- <span data-ttu-id="480c9-107">Cette application doit être exécutée avec élévation de privilèges (exécuter en tant qu’administrateur).</span><span class="sxs-lookup"><span data-stu-id="480c9-107">This application must be run in elevated mode (Run as administrator).</span></span>

## <a name="demonstrates"></a><span data-ttu-id="480c9-108">Montre</span><span class="sxs-lookup"><span data-stu-id="480c9-108">Demonstrates</span></span>

- <span data-ttu-id="480c9-109">Création d’un hôte personnalisé dont les classes dérivées de la [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) (classe), le [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) classe et le [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) classe.</span><span class="sxs-lookup"><span data-stu-id="480c9-109">Creating a custom host whose classes derive from the [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) class, the [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) class, and the [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) class.</span></span>

- <span data-ttu-id="480c9-110">Création d’une application console qui utilise ces classes d’hôte pour créer un interpréteur de commandes Windows PowerShell interactif.</span><span class="sxs-lookup"><span data-stu-id="480c9-110">Building a console application that uses these host classes to build an interactive Windows PowerShell shell.</span></span>

- <span data-ttu-id="480c9-111">Création d’un `$profile` variable et charger les profils suivants.</span><span class="sxs-lookup"><span data-stu-id="480c9-111">Creating a `$profile` variable and loading the following profiles.</span></span>

  - <span data-ttu-id="480c9-112">utilisateur actuel, l’hôte actuel</span><span class="sxs-lookup"><span data-stu-id="480c9-112">current user, current host</span></span>

  - <span data-ttu-id="480c9-113">utilisateur actuel, tous les ordinateurs hôtes</span><span class="sxs-lookup"><span data-stu-id="480c9-113">current user, all hosts</span></span>

  - <span data-ttu-id="480c9-114">tous les utilisateurs, hôte actuel</span><span class="sxs-lookup"><span data-stu-id="480c9-114">all users, current host</span></span>

  - <span data-ttu-id="480c9-115">tous les utilisateurs, tous les ordinateurs hôtes</span><span class="sxs-lookup"><span data-stu-id="480c9-115">all users, all hosts</span></span>

- <span data-ttu-id="480c9-116">Implémentez le [System.Management.Automation.Host.Ihostuisupportsmultiplechoiceselection](/dotnet/api/System.Management.Automation.Host.IHostUISupportsMultipleChoiceSelection) interface.</span><span class="sxs-lookup"><span data-stu-id="480c9-116">Implement the [System.Management.Automation.Host.Ihostuisupportsmultiplechoiceselection](/dotnet/api/System.Management.Automation.Host.IHostUISupportsMultipleChoiceSelection) interface.</span></span>

- <span data-ttu-id="480c9-117">Implémentez le [System.Management.Automation.Host.Ihostsupportsinteractivesession](/dotnet/api/System.Management.Automation.Host.IHostSupportsInteractiveSession) interface pour prendre en charge la communication à distance interactive à l’aide de la [Enter-PsSession](/powershell/module/Microsoft.PowerShell.Core/Enter-PSSession) et [ Exit-PsSession](/powershell/module/Microsoft.PowerShell.Core/Exit-PSSession) applets de commande.</span><span class="sxs-lookup"><span data-stu-id="480c9-117">Implement the [System.Management.Automation.Host.Ihostsupportsinteractivesession](/dotnet/api/System.Management.Automation.Host.IHostSupportsInteractiveSession) interface to support interactive remoting by using the [Enter-PsSession](/powershell/module/Microsoft.PowerShell.Core/Enter-PSSession) and [Exit-PsSession](/powershell/module/Microsoft.PowerShell.Core/Exit-PSSession) cmdlets.</span></span>
- <span data-ttu-id="480c9-118">Implémentez le [System.Management.Automation.Host.Ihostsupportsinteractivesession](/dotnet/api/System.Management.Automation.Host.IHostSupportsInteractiveSession) interface pour prendre en charge la communication à distance interactive à l’aide de la [Enter-PsSession](/powershell/module/Microsoft.PowerShell.Core/Enter-PSSession) et [ Exit-PsSession](/powershell/module/Microsoft.PowerShell.Core/Exit-PSSession) applets de commande.</span><span class="sxs-lookup"><span data-stu-id="480c9-118">Implement the [System.Management.Automation.Host.Ihostsupportsinteractivesession](/dotnet/api/System.Management.Automation.Host.IHostSupportsInteractiveSession) interface to support interactive remoting by using the [Enter-PsSession](/powershell/module/Microsoft.PowerShell.Core/Enter-PSSession) and [Exit-PsSession](/powershell/module/Microsoft.PowerShell.Core/Exit-PSSession) cmdlets.</span></span>

- <span data-ttu-id="480c9-119">Utiliser l’API de marquer pour mettre en couleur de la ligne de commande telle qu’elle est tapée.</span><span class="sxs-lookup"><span data-stu-id="480c9-119">Use the Tokenize API to colorize the command line as it is typed.</span></span>

## <a name="example"></a><span data-ttu-id="480c9-120">Exemple</span><span class="sxs-lookup"><span data-stu-id="480c9-120">Example</span></span>

 <span data-ttu-id="480c9-121">Cet exemple permet à l’utilisateur à entrer des commandes à une ligne de commande, traite ces commandes, puis imprime les résultats.</span><span class="sxs-lookup"><span data-stu-id="480c9-121">This example allows the user to enter commands at a command line, processes those commands, and then prints out the results.</span></span>
...
## <a name="example"></a><span data-ttu-id="480c9-122">Exemple</span><span class="sxs-lookup"><span data-stu-id="480c9-122">Example</span></span>

 <span data-ttu-id="480c9-123">Le code suivant est l’implémentation de la [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) classe qui est utilisée par cette application hôte.</span><span class="sxs-lookup"><span data-stu-id="480c9-123">The following code is the implementation of the [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) class that is used by this host application.</span></span> <span data-ttu-id="480c9-124">Les éléments qui ne sont pas implémentées lèvent une exception ou retournent rien.</span><span class="sxs-lookup"><span data-stu-id="480c9-124">Those elements that are not implemented throw an exception or return nothing.</span></span>
...
## <a name="example"></a><span data-ttu-id="480c9-125">Exemple</span><span class="sxs-lookup"><span data-stu-id="480c9-125">Example</span></span>

 <span data-ttu-id="480c9-126">Le code suivant est l’implémentation de la [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) classe qui est utilisée par cette application hôte.</span><span class="sxs-lookup"><span data-stu-id="480c9-126">The following code is the implementation of the [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) class that is used by this host application.</span></span>
...
## <a name="example"></a><span data-ttu-id="480c9-127">Exemple</span><span class="sxs-lookup"><span data-stu-id="480c9-127">Example</span></span>

 <span data-ttu-id="480c9-128">Le code suivant est l’implémentation de la [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) classe qui est utilisée par cette application hôte.</span><span class="sxs-lookup"><span data-stu-id="480c9-128">The following code is the implementation of the [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) class that is used by this host application.</span></span> <span data-ttu-id="480c9-129">Les éléments qui ne sont pas implémentées lèvent une exception ou retournent rien.</span><span class="sxs-lookup"><span data-stu-id="480c9-129">Those elements that are not implemented throw an exception or return nothing.</span></span>
...
## <a name="example"></a><span data-ttu-id="480c9-130">Exemple</span><span class="sxs-lookup"><span data-stu-id="480c9-130">Example</span></span>

 <span data-ttu-id="480c9-131">Le code suivant lit la ligne de commande et les couleurs du texte tel qu’il est entré.</span><span class="sxs-lookup"><span data-stu-id="480c9-131">The following code reads the command line and colors the text as it is entered.</span></span> <span data-ttu-id="480c9-132">Les jetons sont déterminées à l’aide de la [System.Management.Automation.Psparser.Tokenize\*](/dotnet/api/System.Management.Automation.PSParser.Tokenize) (méthode).</span><span class="sxs-lookup"><span data-stu-id="480c9-132">Tokens are determined by using the [System.Management.Automation.Psparser.Tokenize\*](/dotnet/api/System.Management.Automation.PSParser.Tokenize) method.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="480c9-133">Voir aussi</span><span class="sxs-lookup"><span data-stu-id="480c9-133">See Also</span></span>

 [<span data-ttu-id="480c9-134">System.Management.Automation.Host.PSHost</span><span class="sxs-lookup"><span data-stu-id="480c9-134">System.Management.Automation.Host.PSHost</span></span>](/dotnet/api/System.Management.Automation.Host.PSHost)

 [<span data-ttu-id="480c9-135">System.Management.Automation.Host.Pshostuserinterface</span><span class="sxs-lookup"><span data-stu-id="480c9-135">System.Management.Automation.Host.Pshostuserinterface</span></span>](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface)

 [<span data-ttu-id="480c9-136">System.Management.Automation.Host.Pshostrawuserinterface</span><span class="sxs-lookup"><span data-stu-id="480c9-136">System.Management.Automation.Host.Pshostrawuserinterface</span></span>](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface)
