...
- Cette application doit être exécutée avec élévation de privilèges (exécuter en tant qu’administrateur).

## <a name="demonstrates"></a>Montre

- Création d’un hôte personnalisé dont les classes dérivées de la [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) (classe), le [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) classe et le [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) classe.

- Création d’une application console qui utilise ces classes d’hôte pour créer un interpréteur de commandes Windows PowerShell interactif.

- Création d’un `$profile` variable et charger les profils suivants.

  - utilisateur actuel, l’hôte actuel
...
- Utiliser l’API de marquer pour mettre en couleur de la ligne de commande telle qu’elle est tapée.

## <a name="example"></a>Exemple

 Cet exemple permet à l’utilisateur à entrer des commandes à une ligne de commande, traite ces commandes, puis imprime les résultats.
...
## <a name="example"></a>Exemple
 ...
 Le code suivant est l’implémentation de la [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) classe qui est utilisée par cette application hôte. Les éléments qui ne sont pas implémentées lèvent une exception ou retournent rien.
...
## <a name="example"></a>Exemple
 ...
 Le code suivant est l’implémentation de la [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) classe qui est utilisée par cette application hôte.
...
## <a name="example"></a>Exemple
 ...
 Le code suivant est l’implémentation de la [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) classe qui est utilisée par cette application hôte. Les éléments qui ne sont pas implémentées lèvent une exception ou retournent rien.
...
## <a name="example"></a>Exemple
 ...
 Le code suivant lit la ligne de commande et les couleurs du texte tel qu’il est entré. Les jetons sont déterminées à l’aide de la [System.Management.Automation.Psparser.Tokenize*](/dotnet/api/System.Management.Automation.PSParser.Tokenize) (méthode).
