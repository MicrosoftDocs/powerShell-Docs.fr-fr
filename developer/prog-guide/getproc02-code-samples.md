...
ms.locfileid: "57429599"
---
# <a name="getproc02-code-samples"></a>Exemples de code GetProc02

Voici les exemples de code pour l’applet de commande GetProc02 exemple. Il s’agit du `Get-Process` exemple d’applet de commande décrites dans [Ajout de paramètres qui traitent les entrées de ligne de commande](../cmdlet/adding-parameters-that-process-command-line-input.md). Cela `Get-Process` applet de commande récupère les processus en se basant sur son nom, puis affiche des informations sur les processus à la ligne de commande.
...
|Langue|Rubrique|
|--------------|-----------|
|C#|[GetProc02 (C#) exemple de Code](./getproc02-csharp-sample-code.md)|
|VB.NET|[GetProc02 exemple de Code (VB.NET)](./getproc02-vb-net-sample-code.md)|
