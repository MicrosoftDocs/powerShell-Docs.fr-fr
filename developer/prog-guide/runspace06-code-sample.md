...
Voici le code source pour l’exemple Runspace06 décrit dans [configuration d’une instance d’exécution à l’aide un Windows PowerShell Snap-in](https://msdn.microsoft.com/en-us/a7289ee8-9732-49ee-91c7-d533e9538b83). Cet exemple d’application crée une instance d’exécution basée sur un composant logiciel enfichable Windows PowerShell, qui est ensuite utilisé pour exécuter un pipeline avec une seule commande. Pour ce faire, l’application crée les informations de configuration d’instance d’exécution, crée une instance d’exécution, crée un pipeline avec une seule commande, puis exécute le pipeline.
