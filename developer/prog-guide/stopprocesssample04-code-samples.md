...
|Language|Rubrique|
|--------------|-----------|
|C#|[StopProc04 (C#) exemple de Code](./stopprocesssample04-csharp-sample-code.md)|
|VB.NET|[StopProc04 exemple de Code (VB.NET)](./stopprocesssample04-vb-net-sample-code.md)|
