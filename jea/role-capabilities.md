...
Vous pouvez créer un fichier de capacités de rôle PowerShell avec l’applet de commande [New-PSRoleCapabilityFile](/powershell/module/microsoft.powershell.core/new-psrolecapabilityfile?view=powershell-6).
...
Pour plus d’informations sur les modules PowerShell, consultez [Comprendre un module PowerShell](/powershell/developer/windows-powershell).
