...
Par défaut, cela comprend les modules disponibles dans le PowerShell Gallery avec la balise **PackageManagement** .
...
Utilisez ensuite `Import-PackageProvider -Name NuGet -RequiredVersion 2.8.5.201` pour importer le fournisseur dans la session PowerShell active.
