...
Si le bloc de commentaires contient une erreur, cette applet de commande retourne des informations sur l’emplacement de l’erreur ou sur la manière de la corriger.
...
Cette commande teste le New-ScriptFile.ps1 fichier de script et affiche les résultats.
Le fichier de script contient des métadonnées valides.
...
Cette commande teste le fichier de script Test-Runbook.ps1 et utilise l’opérateur de pipeline pour transmettre les résultats à l’applet de commande Format-List pour mettre en forme les résultats.
...
Cette commande teste le fichier de script Hello-World.ps1, à laquelle aucune métadonnée n’est associée.
...
Contrairement au paramètre *path* , la valeur du paramètre *LiteralPath* est utilisée exactement telle qu’elle est entrée.
Aucun caractère n’est interprété en tant que caractère générique.
Si le chemin d’accès comprend des caractères d’échappement, placez-les entre guillemets simples.
