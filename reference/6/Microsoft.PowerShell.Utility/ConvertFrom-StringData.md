...
### Exemple 2 : convertir une chaîne here contenant un commentaire
...
### Exemple 3 : convertir une chaîne en une table de hachage
...
### Exemple 4 : utiliser ConvertFrom-StringData dans la section de données d’un script
...
### Exemple 7 : utiliser le caractère d’échappement barre oblique inverse pour restituer correctement un chemin d’accès de fichier
