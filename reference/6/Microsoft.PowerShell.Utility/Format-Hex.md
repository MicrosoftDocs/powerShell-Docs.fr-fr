...
Spécifie l’encodage de la sortie. Cela s’applique uniquement à l' `[string]` entrée. Le paramètre n’a aucun effet sur les types numériques. La valeur par défaut est `utf8NoBOM`.
