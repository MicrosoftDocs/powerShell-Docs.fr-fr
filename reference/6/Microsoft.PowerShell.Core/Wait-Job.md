...
L’applet de commande **Wait-Job** attend que les tâches en arrière-plan PowerShell se terminent avant d’afficher l’invite de commandes.
...
La première commande crée une session PowerShell ( **PSSession** ) sur chacun des trois ordinateurs distants et les stocke dans la variable $s.
...
Ces commandes démarrent une tâche qui obtient les fichiers de script PowerShell qui ont été ajoutés ou mis à jour au cours de la semaine dernière.
