...
L’applet de commande **Find-script** recherche un script spécifié dans les dépôts inscrits.
...
### Exemple 3 : Rechercher un script par nom, version requise et à partir d’un référentiel spécifié

```
PS C:\> Find-Script -Name "Required-Script2" -RequiredVersion 2.0 -Repository "LocalRepo01"
```

Cette commande recherche un script par nom et la version requise dans le référentiel LocalRepo01.
...
Cette commande recherche Required-Script2 dans le référentiel LocalRepo1, puis passe l’objet **PSRepositoryItemInfo** résultant à l’applet de commande Format-List.
...
Cette commande recherche les scripts qui ont la balise : Étiquette1 dans le référentiel LocalRepo1

### Exemple 9 : Rechercher les scripts avec le nom de commande spécifié
...
### Exemple 10 : Rechercher des scripts avec des flux de travail
...
Cette commande recherche les scripts de workflow dans le référentiel LocalRepo1.
...
Cette commande utilise le caractère générique (*) pour rechercher les scripts qui commencent par le script requis.
...
Spécifie un tableau de commandes à rechercher dans les scripts.
Une commande peut être une fonction ou un flux de travail.
...
Recherche des scripts en fonction de la syntaxe de recherche spécifique au fournisseur PackageManagement.
...
Spécifie le type de script à récupérer.
Les valeurs acceptables pour ce paramètre sont : function, Workflow.
...
Spécifie la version maximale ou la plus récente du script à rechercher.
...
Spécifie la version minimale du script à rechercher.
...
Spécifie le nom convivial d’un référentiel inscrit en exécutant Register-PSRepository.
