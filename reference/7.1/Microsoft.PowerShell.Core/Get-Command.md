...
### Exemple 11 : récupération d’une syntaxe à partir d’un alias

Cet exemple montre comment récupérer la syntaxe avec le nom standard d’un alias.
...
### Exemple 12 : récupération de toutes les instances de la commande Notepad

Cet exemple utilise le paramètre **All** de l' `Get-Command` applet de commande pour afficher toutes les instances de la `Notepad` commande sur l’ordinateur local.
...
- Alias. Obtient le nom standard et la syntaxe.
