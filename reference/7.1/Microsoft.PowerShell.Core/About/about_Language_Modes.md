...
Les manifestes de module, qui utilisent le mode RestrictedLanguage, autorisent également les variables supplémentaires suivantes :

- `$PSScriptRoot`
- `$PSEdition` (dans PowerShell Core)
- `$EnabledExperimentalFeatures` (dans PowerShell Core)
