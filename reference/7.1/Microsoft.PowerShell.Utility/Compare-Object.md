...
À partir de PowerShell 7,1, lors de l’utilisation du paramètre **ExcludeDifferent** , **includeequal** est déduit et la sortie contient uniquement les lignes contenues dans les deux fichiers, comme le montre le **SideIndicator** ( `==` ).
