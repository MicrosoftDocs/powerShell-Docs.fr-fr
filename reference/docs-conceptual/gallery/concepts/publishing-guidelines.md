...
Pour connaître le mécanisme de publication d’un package sur PowerShell Gallery, voir [Créer et publier un package](../how-to/publishing-packages/publishing-a-package.md).
...
![exemple de protection de compatibilité](media/publishing-guidelines/CosmosDB.svg).
