...
2. Deux volets de l’éditeur apparaissent.
...
3. Remplacez le paramètre par le chemin vers l’exécutable PowerShell souhaité
4. Enregistrez le fichier de paramètres et redémarrez Visual Studio Code
