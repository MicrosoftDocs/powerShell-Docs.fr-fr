...
Windows PowerShell utilise le nom **Location** pour faire référence au répertoire de travail. Il implémente également une famille d'applets de commande pour vous permettre d'examiner et de manipuler votre emplacement.
...
La commande **Get-Location** s'utilise avec la commande **Set-Location** . La commande **Set-Location** vous permet de spécifier l'emplacement de votre répertoire actif.
...
Pour revenir au répertoire le plus récemment visité, entrez la commande **Pop-Location** . Ensuite, pour vérifier le changement, entrez la commande **Get-Location**  :
...
Comme avec l'applet de commande **Set-Location** , vous pouvez inclure le paramètre **-PassThru** au moment d'entrer l'applet de commande **Pop-Location** pour afficher le répertoire entré :
