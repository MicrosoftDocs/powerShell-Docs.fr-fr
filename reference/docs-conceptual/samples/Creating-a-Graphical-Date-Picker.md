...
Le script commence par charger deux classes du .NET Framework : **System.Drawing** et **System.Windows.Forms**. Démarrez ensuite une nouvelle instance de la classe .NET Framework **Windows.Forms.Form**. Celle-ci fournit une fenêtre ou un formulaire vide où vous pouvez ajouter des contrôles.
...
- [Astuce Windows PowerShell de la semaine : création d’un sélecteur de dates graphique](https://technet.microsoft.com/library/ff730942.aspx)