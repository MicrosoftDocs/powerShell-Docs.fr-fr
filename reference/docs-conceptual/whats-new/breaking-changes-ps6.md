...
### <a name="dont-insert-line-breaks-to-output-except-for-tables-5193httpsgithubcompowershellpowershellissues5193"></a>Ne pas insérer de sauts de ligne en sortie (sauf pour les tables) [#5193](https://github.com/PowerShell/PowerShell/issues/5193)
...
### <a name="skip-null-element-check-for-collections-with-a-value-type-element-type-5432httpsgithubcompowershellpowershellissues5432"></a>Ignorer la vérification de l’élément null pour les collections avec un élément de type valeur [#5432](https://github.com/PowerShell/PowerShell/issues/5432)
...
### <a name="change-outputencoding-to-use-utf-8-nobom-encoding-rather-than-ascii-5369httpsgithubcompowershellpowershellissues5369"></a>Modifier `$OutputEncoding` pour utiliser l’encodage `UTF-8 NoBOM` plutôt qu’ASCII [#5369](https://github.com/PowerShell/PowerShell/issues/5369)
...
### <a name="remove-allscope-from-most-default-aliases-5268httpsgithubcompowershellpowershellissues5268"></a>Supprimer `AllScope` de la plupart des alias par défaut [#5268](https://github.com/PowerShell/PowerShell/issues/5268)
...
### <a name="-verbose-and--debug-no-longer-overrides-erroractionpreference-5113httpsgithubcompowershellpowershellissues5113"></a>`-Verbose` et `-Debug` ne remplacent plus `$ErrorActionPreference` [#5113](https://github.com/PowerShell/PowerShell/issues/5113)
...
### <a name="invoke-restmethod-doesnt-return-useful-info-when-no-data-is-returned-5320httpsgithubcompowershellpowershellissues5320"></a>Invoke-RestMethod ne retourne pas d’informations utiles quand aucune donnée n’est retournée. [#5320](https://github.com/PowerShell/PowerShell/issues/5320)
...
### <a name="fix-get-item--literalpath-ab-if-ab-doesnt-actually-exist-to-return-error-5197httpsgithubcompowershellpowershellissues5197"></a>Corriger `Get-Item -LiteralPath a*b` si `a*b` n’existe pas réellement pour retourner l’erreur [#5197](https://github.com/PowerShell/PowerShell/issues/5197)
...
### <a name="import-csv-should-apply-pstypenames-upon-import-when-type-information-is-present-in-the-csv-5134httpsgithubcompowershellpowershellissues5134"></a>`Import-Csv` doit appliquer `PSTypeNames` lors de l’importation lorsque les informations de type sont présentes dans le CSV [#5134](https://github.com/PowerShell/PowerShell/issues/5134)
...
### <a name="-notypeinformation-should-be-default-on-export-csv-5131httpsgithubcompowershellpowershellissues5131"></a>`-NoTypeInformation` doit prendre la valeur par défaut `Export-Csv` [#5131](https://github.com/PowerShell/PowerShell/issues/5131)
...
### <a name="web-cmdlets-should-warn-when--credential-is-sent-over-unencrypted-connections-5112httpsgithubcompowershellpowershellissues5112"></a>Les cmdlets web doivent signaler lorsque `-Credential` est envoyé via des connexions non chiffrées [#5112](https://github.com/PowerShell/PowerShell/issues/5112)
...
### <a name="unify-cmdlets-with-parameter--encoding-to-be-of-type-systemtextencoding-5080httpsgithubcompowershellpowershellissues5080"></a>Unifier les cmdlets avec le paramètre `-Encoding` de type `System.Text.Encoding` [#5080](https://github.com/PowerShell/PowerShell/issues/5080)
...
### <a name="add-better-error-message-for-empty-and-null--uformat-parameter-5055httpsgithubcompowershellpowershellissues5055"></a>Ajouter un meilleur message d’erreur si le paramètre `-UFormat` est vide ou null [#5055](https://github.com/PowerShell/PowerShell/issues/5055)
...
### <a name="clean-up-console-code-4995httpsgithubcompowershellpowershellissues4995"></a>Nettoyer le code de la console [#4995](https://github.com/PowerShell/PowerShell/issues/4995)
...
### <a name="commandinvocationintrinsicsinvokescript-bind-arguments-to-input-instead-of-args-4923httpsgithubcompowershellpowershellissues4923"></a>`CommandInvocationIntrinsics.InvokeScript` lie les arguments à `$input` au lieu de `$args` [#4923](https://github.com/PowerShell/PowerShell/issues/4923)
...
### <a name="allow--to-be-used-in-registry-path-for-remove-item-4866httpsgithubcompowershellpowershellissues4866"></a>Autoriser l’utilisation de * dans le chemin du registre pour `Remove-Item` [#4866](https://github.com/PowerShell/PowerShell/issues/4866)
...
### <a name="make-error-message-consistent-when-invalid-script-is-passed-to--file-better-error-when-passed-ambiguous-argument-4573httpsgithubcompowershellpowershellissues4573"></a>Uniformiser le message d’erreur lorsqu’un script non valide est transmis à -File, erreur optimisée lors de l’envoi d’un argument ambigu [#4573](https://github.com/PowerShell/PowerShell/issues/4573)

Modifier les codes de sortie de `pwsh.exe` pour se conformer aux conventions Unix

### <a name="removal-of-localaccount-and-cmdlets-from--diagnostics-modules-4302httpsgithubcompowershellpowershellissues4302-4303httpsgithubcompowershellpowershellissues4303"></a>Suppression de `LocalAccount` et des cmdlets des modules `Diagnostics`. [#4302](https://github.com/PowerShell/PowerShell/issues/4302) [#4303](https://github.com/PowerShell/PowerShell/issues/4303)
...
### <a name="prevent-get-childitem-from-recursing-into-symlinks-1875-3780httpsgithubcompowershellpowershellissues3780"></a>Empêcher la récurrence de `Get-ChildItem` dans des liens symboliques (#1875). [#3780](https://github.com/PowerShell/PowerShell/issues/3780)
...
### <a name="fix-get-content--delimiter-to-not-include-the-delimiter-in-the-returned-lines-3706httpsgithubcompowershellpowershellissues3706"></a>Corriger `Get-Content -Delimiter` pour ne pas inclure le délimiteur dans les lignes retournées [#3706](https://github.com/PowerShell/PowerShell/issues/3706)
...
### <a name="implement-format-hex-in-c-3320httpsgithubcompowershellpowershellissues3320"></a>Implémenter Format-Hex dans C# [#3320](https://github.com/PowerShell/PowerShell/issues/3320)
...
### <a name="powershell-as-a-default-shell-doesnt-work-with-script-command-3319httpsgithubcompowershellpowershellissues3319"></a>PowerShell en tant que shell par défaut ne fonctionne pas avec la commande de script [#3319](https://github.com/PowerShell/PowerShell/issues/3319)
...
### <a name="typo-fix-in-get-computerinfo-property-name-3167httpsgithubcompowershellpowershellissues3167"></a>Correction typographique dans le nom de la propriété Get-ComputerInfo [#3167](https://github.com/PowerShell/PowerShell/issues/3167)
...
### <a name="add-validation-on-get--cmdlets-where-passing-null-returns-all-objects-instead-of-error-2672httpsgithubcompowershellpowershellissues2672"></a>Ajouter la validation sur les cmdlets `Get-*` où la transmission de $null retourne tous les objets au lieu de l’erreur [#2672](https://github.com/PowerShell/PowerShell/issues/2672)
...
### <a name="parameter-binding-problem-with-valuefromremainingarguments-in-ps-functions-2035httpsgithubcompowershellpowershellissues2035"></a>Problème de liaison de paramètre avec `ValueFromRemainingArguments` dans les fonctions PS [#2035](https://github.com/PowerShell/PowerShell/issues/2035)
...
### <a name="buildversion-is-removed-from-psversiontable-1415httpsgithubcompowershellpowershellissues1415"></a>`BuildVersion` est supprimé de `$PSVersionTable` [#1415](https://github.com/PowerShell/PowerShell/issues/1415)
