...
L’extension IIS Management OData utilise des fichiers XML pour définir le mappage des ressources. Le XSD suivant définit le schéma utilisé pour ces fichiers.

## <a name="resource-mapping-file-xsd"></a>Fichier de mappage de ressources XSD

Le schéma XSD suivant définit le schéma pour les fichiers de mappage des ressources d’extension IIS de gestion OData.
