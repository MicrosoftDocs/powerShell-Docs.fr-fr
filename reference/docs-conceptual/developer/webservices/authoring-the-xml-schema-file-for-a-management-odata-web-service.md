...
La première partie du fichier XML mappe les ressources définies dans le fichier de schéma MOF aux URL utilisées pour y accéder. L’exemple suivant montre ce mappage.
...
## <a name="mapping-cmdlets-to-crud-operations"></a>Mappage des applets de commande aux opérations CRUD

Vous spécifiez ensuite les applets de commande qui correspondent aux opérations CRUD (création, lecture, mise à jour et suppression) prises en charge par les ressources. Dans le schéma de [mappage des ressources](./resource-mapping-schema.md)OData de gestion, les opérations CRUD sont mappées comme suit.
