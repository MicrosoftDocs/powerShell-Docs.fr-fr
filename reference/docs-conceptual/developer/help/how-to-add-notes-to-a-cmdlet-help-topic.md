...
Le code XML suivant montre un nœud \<maml : alertSet > avec deux notes. Notez que chaque note a une balise facultative \<maml : title > (les titres peuvent être utilisés pour regrouper n’importe quel ensemble de balises de \<maml : Alert >), et que chaque note contient une ligne vide suivant le contenu pour l’espacement.
