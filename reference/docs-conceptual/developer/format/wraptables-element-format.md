...
Spécifie que les données d’une cellule de tableau sont déplacées vers la ligne suivante si les données sont plus longues que la largeur de la colonne.

Élément de configuration (format) DefaultSettings, élément (format) WrapTables, élément (format)
