...
Vous pouvez utiliser les objets exposés par l’espace de noms N :Microsoft.PowerShell.ScheduledJob pour créer une tâche planifiée, définir le moment de son exécution et obtenir des résultats sur la tâche terminée après son exécution.

## <a name="triggering-the-job"></a>Déclenchement du travail

La première étape de la création d’une tâche planifiée consiste à spécifier le moment où le travail doit s’exécuter. Pour ce faire, créez et configurez un objet T :Microsoft.PowerShell.ScheduledJob.ScheduledJobTrigger. Le code suivant crée un déclencheur qui planifie une tâche pour qu’elle s’exécute une seule fois 20 secondes à l’avenir.
...
Vous définissez un travail Windows PowerShell en créant un dictionnaire de paramètres. Les paramètres suivants sont pris en charge.
...
Vous créez ensuite des objets ScheduledJobInvocationInfo et ScheduledJobDefinition pour exécuter le travail. Le code suivant illustre cette méthode.
...
## <a name="registering-the-job-with-the-task-scheduler"></a>Inscription du travail avec le Planificateur de tâches
