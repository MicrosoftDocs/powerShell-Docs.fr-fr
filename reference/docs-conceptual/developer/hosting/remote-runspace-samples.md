...
> [!NOTE]
> Pour plus d’informations sur l’exécution de commandes sur un ordinateur distant, consultez communication à distance [Windows PowerShell](https://msdn.microsoft.com/en-us/library/ee706563(v=vs.85).aspx).
