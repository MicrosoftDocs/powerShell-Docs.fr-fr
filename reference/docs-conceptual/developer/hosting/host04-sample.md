...
ms.date: 09/13/2016
ms.topic: reference
title: Exemple Host04
description: Exemple Host04
ms.openlocfilehash: a768258d58d39d0067c5a2a9c40d74e32bf64943
ms.sourcegitcommit: ba7315a496986451cfc1296b659d73ea2373d3f0
ms.translationtype: MT
ms.contentlocale: fr-FR
ms.lasthandoff: 12/10/2020
ms.locfileid: "93355423"
---
# <a name="host04-sample"></a><span data-ttu-id="282dd-103">Exemple Host04</span><span class="sxs-lookup"><span data-stu-id="282dd-103">Host04 Sample</span></span>

<span data-ttu-id="282dd-104">Cet exemple montre comment créer une application hôte basée sur une console interactive qui lit les commandes à partir de la ligne de commande, exécute les commandes, puis affiche les résultats dans la console.</span><span class="sxs-lookup"><span data-stu-id="282dd-104">This sample shows how to build an interactive console-based host application that reads commands from the command line, executes the commands, and then displays the results to the console.</span></span> <span data-ttu-id="282dd-105">Cette application hôte prend aussi en charge l’affichage d’invites qui permettent à l’utilisateur de spécifier plusieurs options.</span><span class="sxs-lookup"><span data-stu-id="282dd-105">This host application also supports displaying prompts that allow the user to specify multiple choices.</span></span>

## <a name="requirements"></a><span data-ttu-id="282dd-106">Spécifications</span><span class="sxs-lookup"><span data-stu-id="282dd-106">Requirements</span></span>

<span data-ttu-id="282dd-107">Cet exemple requiert Windows PowerShell 2,0.</span><span class="sxs-lookup"><span data-stu-id="282dd-107">This sample requires Windows PowerShell 2.0.</span></span>

## <a name="demonstrates"></a><span data-ttu-id="282dd-108">Illustre le</span><span class="sxs-lookup"><span data-stu-id="282dd-108">Demonstrates</span></span>

- <span data-ttu-id="282dd-109">Création d’un hôte personnalisé dont les classes dérivent de la classe [System. Management. Automation. Host. PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) , de la classe System. Management. Automation. [host. PSHostUserInterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) et de la classe [System. Management. Automation. Host. PSHostRawUserInterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) .</span><span class="sxs-lookup"><span data-stu-id="282dd-109">Creating a custom host whose classes derive from the [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) class, the [System.Management.Automation.Host.PSHostUserInterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) class, and the [System.Management.Automation.Host.PSHostRawUserInterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) class.</span></span>

- <span data-ttu-id="282dd-110">Génération d’une application console qui utilise ces classes hôtes pour créer un interpréteur de commandes Windows PowerShell interactif.</span><span class="sxs-lookup"><span data-stu-id="282dd-110">Building a console application that uses these host classes to build an interactive Windows PowerShell shell.</span></span>

- <span data-ttu-id="282dd-111">Création d’une `$profile` variable et chargement des profils suivants.</span><span class="sxs-lookup"><span data-stu-id="282dd-111">Creating a `$profile` variable and loading the following profiles.</span></span>

  - <span data-ttu-id="282dd-112">utilisateur actuel, hôte actuel</span><span class="sxs-lookup"><span data-stu-id="282dd-112">current user, current host</span></span>
  - <span data-ttu-id="282dd-113">utilisateur actuel, tous les ordinateurs hôtes</span><span class="sxs-lookup"><span data-stu-id="282dd-113">current user, all hosts</span></span>
  - <span data-ttu-id="282dd-114">tous les utilisateurs, hôte actuel</span><span class="sxs-lookup"><span data-stu-id="282dd-114">all users, current host</span></span>
  - <span data-ttu-id="282dd-115">tous les utilisateurs, tous les ordinateurs hôtes</span><span class="sxs-lookup"><span data-stu-id="282dd-115">all users, all hosts</span></span>

- <span data-ttu-id="282dd-116">Implémentez l’interface [System. Management. Automation. Host. IHostUISupportsMultipleChoiceSelection](/dotnet/api/System.Management.Automation.Host.IHostUISupportsMultipleChoiceSelection) .</span><span class="sxs-lookup"><span data-stu-id="282dd-116">Implement the [System.Management.Automation.Host.IHostUISupportsMultipleChoiceSelection](/dotnet/api/System.Management.Automation.Host.IHostUISupportsMultipleChoiceSelection) interface.</span></span>

## <a name="example-1"></a><span data-ttu-id="282dd-117">Exemple 1</span><span class="sxs-lookup"><span data-stu-id="282dd-117">Example 1</span></span>

<span data-ttu-id="282dd-118">Cet exemple permet à l’utilisateur d’entrer des commandes sur une ligne de commande, de traiter ces commandes, puis d’imprimer les résultats.</span><span class="sxs-lookup"><span data-stu-id="282dd-118">This example allows the user to enter commands at a command line, processes those commands, and then prints out the results.</span></span>
...
## <a name="example-2"></a><span data-ttu-id="282dd-119">Exemple 2</span><span class="sxs-lookup"><span data-stu-id="282dd-119">Example 2</span></span>

<span data-ttu-id="282dd-120">Le code suivant correspond à l’implémentation de la classe [System. Management. Automation. Host. PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) qui est utilisée par cette application hôte.</span><span class="sxs-lookup"><span data-stu-id="282dd-120">The following code is the implementation of the [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) class that is used by this host application.</span></span> <span data-ttu-id="282dd-121">Les éléments qui ne sont pas implémentés lèvent une exception ou ne retournent rien.</span><span class="sxs-lookup"><span data-stu-id="282dd-121">Those elements that are not implemented throw an exception or return nothing.</span></span>
...
## <a name="example-3"></a><span data-ttu-id="282dd-122">Exemple 3</span><span class="sxs-lookup"><span data-stu-id="282dd-122">Example 3</span></span>

<span data-ttu-id="282dd-123">Le code suivant correspond à l’implémentation de la classe [System. Management. Automation. Host. Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) qui est utilisée par cette application hôte.</span><span class="sxs-lookup"><span data-stu-id="282dd-123">The following code is the implementation of the [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) class that is used by this host application.</span></span>
...
## <a name="example-4"></a><span data-ttu-id="282dd-124">Exemple 4</span><span class="sxs-lookup"><span data-stu-id="282dd-124">Example 4</span></span>

<span data-ttu-id="282dd-125">Le code suivant correspond à l’implémentation de la classe [System. Management. Automation. Host. Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) qui est utilisée par cette application hôte.</span><span class="sxs-lookup"><span data-stu-id="282dd-125">The following code is the implementation of the [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) class that is used by this host application.</span></span> <span data-ttu-id="282dd-126">Les éléments qui ne sont pas implémentés lèvent une exception ou ne retournent rien.</span><span class="sxs-lookup"><span data-stu-id="282dd-126">Those elements that are not implemented throw an exception or return nothing.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="282dd-127">Voir aussi</span><span class="sxs-lookup"><span data-stu-id="282dd-127">See Also</span></span>

 [<span data-ttu-id="282dd-128">System. Management. Automation. Host. PSHost</span><span class="sxs-lookup"><span data-stu-id="282dd-128">System.Management.Automation.Host.PSHost</span></span>](/dotnet/api/System.Management.Automation.Host.PSHost)

 [<span data-ttu-id="282dd-129">System. Management. Automation. Host. Pshostuserinterface</span><span class="sxs-lookup"><span data-stu-id="282dd-129">System.Management.Automation.Host.Pshostuserinterface</span></span>](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface)

 [<span data-ttu-id="282dd-130">System. Management. Automation. Host. Pshostrawuserinterface</span><span class="sxs-lookup"><span data-stu-id="282dd-130">System.Management.Automation.Host.Pshostrawuserinterface</span></span>](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface)
