...
---
# <a name="runspace02-code-samples"></a>Exemples de code Runspace02
...
|Language|Rubrique|
|--------------|-----------|
|C#|[Exemple deC#code Runspace02 ()](./runspace02-csharp-code-sample.md)|
|VB.NET|[Exemple de code Runspace02 (VB.NET)](./runspace02-vb-net-code-sample.md)|
