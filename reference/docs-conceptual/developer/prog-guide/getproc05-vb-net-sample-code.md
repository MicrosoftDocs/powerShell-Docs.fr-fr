...
---
# <a name="getproc05-vbnet-sample-code"></a><span data-ttu-id="e9a09-102">Exemple de code GetProc05 (VB.NET)</span><span class="sxs-lookup"><span data-stu-id="e9a09-102">GetProc05 (VB.NET) Sample Code</span></span>

<span data-ttu-id="e9a09-103">Voici le code VB.NET complet de l’applet de commande GetProc05 Sample.</span><span class="sxs-lookup"><span data-stu-id="e9a09-103">Here is the complete VB.NET code for the GetProc05 sample cmdlet.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="e9a09-104">Voir aussi</span><span class="sxs-lookup"><span data-stu-id="e9a09-104">See Also</span></span>

[<span data-ttu-id="e9a09-105">Windows PowerShell SDK</span><span class="sxs-lookup"><span data-stu-id="e9a09-105">Windows PowerShell SDK</span></span>](../windows-powershell-reference.md)