...
---
# <a name="accessdbprovidersample06-code-sample"></a>Exemple de code AccessDbProviderSample06

Le code suivant illustre l’implémentation du fournisseur de contenu Windows PowerShell décrit dans [création d’un fournisseur de contenu Windows PowerShell](./creating-a-windows-powershell-content-provider.md). Ce fournisseur permet à l’utilisateur de manipuler le contenu des éléments d’un magasin de données.
