...
|---|---|
|**All**<br>Type de données : booléen|Implémentez ce paramètre afin que `true` indique que toutes les ressources doivent être traitées au lieu d’un sous-ensemble de ressources par défaut. Implémentez ce paramètre afin que `false` indique un sous-ensemble des ressources.|
...
|**Compter**<br>Type de données : Int64|Implémentez ce paramètre afin que l’utilisateur puisse spécifier le nombre.|
|**Portée**<br>Type de données : mot clé|Implémentez ce paramètre pour permettre à l’utilisateur de spécifier l’étendue à utiliser.|
