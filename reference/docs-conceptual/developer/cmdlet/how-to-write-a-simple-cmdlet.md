...
Cet article explique comment écrire une applet de commande. L’applet de commande `Send-Greeting` accepte un nom d’utilisateur unique comme entrée, puis écrit un message d’accueil à cet utilisateur. Bien que l’applet de commande n’effectue pas de nombreuses tâches, cet exemple illustre les principales sections d’une applet de commande.
