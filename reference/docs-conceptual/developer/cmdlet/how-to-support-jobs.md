...
L’exemple de code suivant montre le code d’une applet de commande **« obtenir-proc »** qui peut récupérer des processus en interne ou à l’aide d’une tâche en arrière-plan.
