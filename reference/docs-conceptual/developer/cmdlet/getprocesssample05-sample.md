...
Cet exemple montre une version complète de l’applet de commande obtenir-proc.
...
1. Ouvrez l’Explorateur Windows et accédez au répertoire GetProcessSample05 sous le répertoire Samples.
   ...
   Une fois le kit de développement logiciel (SDK) 2,0 Windows PowerShell installé, accédez au dossier GetProcessSample05. L’emplacement par défaut est C:\Program Files (x86) \Microsoft SDKs\Windows\v7.0\Samples\sysmgmt\WindowsPowerShell\csharp\GetProcessSample05.
...
- La spécification de ces paramètres peut prendre une entrée du pipeline. L’entrée peut être extraite à partir d’un objet ou d’une valeur d’une propriété d’un objet dont le nom de la propriété est le même que le nom du paramètre.

- Déclaration d’un attribut de validation pour l’entrée de paramètre.

- Gestion des erreurs et des exceptions.

- Écriture des messages de débogage.
