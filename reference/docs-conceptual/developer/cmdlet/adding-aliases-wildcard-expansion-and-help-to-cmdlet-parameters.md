...
- À présent, effectuez l’entrée suivante pour arrêter tous les processus qui correspondent au modèle de caractère générique « * note @ no__t-0 ». Vous êtes invité à arrêter chaque processus correspondant au modèle.
