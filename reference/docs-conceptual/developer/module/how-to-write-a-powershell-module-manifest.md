...
|**Tags** <br /> Entrez : `String[]` |`@()`| Balises aide sur la découverte de modules dans les galeries en ligne. <br /> Exemple : `Tags = "PackageManagement", "PowerShell", "Manifest"`|
