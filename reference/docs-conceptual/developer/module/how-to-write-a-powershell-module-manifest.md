...
|**UNIQUES**<br /> Type : `GUID`|`'<GUID>'`|ID utilisé pour identifier de manière unique ce module. Si une valeur n’est pas spécifiée, `New-ModuleManifest` génère automatiquement la valeur. Actuellement, vous ne pouvez pas importer un module par **GUID**. <br /> Exemple : `GUID = 'cfc45206-1e49-459d-a8ad-5b571ef94857'`|
