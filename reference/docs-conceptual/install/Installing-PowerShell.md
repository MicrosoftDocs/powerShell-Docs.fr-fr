...
Au fil des années, de nombreuses versions de PowerShell ont été publiées. Initialement, Windows PowerShell a été conçu sur le .NET Framework et ne fonctionnait que sur les systèmes Windows. Avec la version actuelle, PowerShell Core utilise .NET Core 2.x comme runtime. PowerShell Core prend en charge les plateformes Windows, macOS et Linux.
