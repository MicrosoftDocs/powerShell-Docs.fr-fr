...
Téléchargez le package Debian `powershell_7.1.2-1.ubuntu.16.04_amd64.deb` à partir de la page de [versions][] sur l’ordinateur Ubuntu.
...
Téléchargez le package Debian `powershell_7.1.2-1.ubuntu.18.04_amd64.deb` à partir de la page de [versions][] sur l’ordinateur Ubuntu.
...
Téléchargez le package Debian `powershell_7.1.2-1.ubuntu.20.04_amd64.deb` à partir de la page de [versions][] sur l’ordinateur Ubuntu.
...
Téléchargez le package Debian `powershell_7.1.2-1.debian.9_amd64.deb` à partir de la page de [versions][] sur l’ordinateur Debian.
...
Téléchargez le package tar.gz `powershell-7.1.2-linux-x64.tar.gz` à partir de la page de [versions][] sur l’ordinateur Debian.
...
Téléchargez le package tar.gz `powershell-7.1.2-linux-alpine-x64.tar.gz` à partir de la page de [versions][] sur l’ordinateur Alpine.
...
À l’aide de [CentOS 7][], téléchargez le package RPM `powershell-7.1.2-1.rhel.7.x86_64.rpm` à partir de la page de [versions][] sur l’ordinateur CentOS.
...
Téléchargez le package RPM `powershell-7.1.2-1.rhel.7.x86_64.rpm` à partir de la page de [versions][] sur l’ordinateur Red Hat Enterprise Linux.
...
Téléchargez le package RPM `powershell-7.1.2-1.rhel.7.x86_64.rpm` à partir de la page de [versions][] sur l’ordinateur Fedora.
