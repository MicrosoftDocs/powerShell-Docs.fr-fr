...
## <a name="using-the-composite-resource"></a><span data-ttu-id="e1d1a-124">Utilisation de la ressource composite</span><span class="sxs-lookup"><span data-stu-id="e1d1a-124">Using the composite resource</span></span>
