...
Pour démarrer Windows PowerShell&reg; sur Windows Server&reg; 2012 R2, Windows&reg; 8.1, Windows Server 2012 et Windows 8, consultez [Tâches de gestion courantes et navigation dans Windows](/previous-versions/windows/it-pro/windows-server-2012-R2-and-2012/hh831491(v=ws.11)).
...
| Document | Lien |
| ----- | ----- |
| Référence des applets de commande | [Navigateur du module PowerShell](/powershell/module/) |
| Installation sur Windows | [Installation de PowerShell Core sur Windows](/powershell/scripting/install/installing-powershell-core-on-windows) |
| Installation sur macOS | [Installation de PowerShell Core sur macOS](/powershell/scripting/install/installing-powershell-core-on-macos) |
| Installation sur Linux | [Installation de PowerShell Core sur Linux](/powershell/scripting/install/installing-powershell-core-on-linux) |
...
Vous pouvez également utiliser les paramètres du programme `powershell.exe` pour personnaliser la session. Pour plus d’informations, voir [Aide sur la ligne de commande PowerShell.exe](/powershell/module/Microsoft.PowerShell.Core/About/about_PowerShell_exe).
...
#### <a name="in-windows-serverreg-2012-r2"></a>Dans Windows Server&reg; 2012 R2
...
#### <a name="in-windows-serverreg-2012"></a>Dans Windows Server&reg; 2012
...
#### <a name="in-windowsreg-81"></a>Dans Windows&reg; 8.1
...
#### <a name="in-windowsreg-8"></a>Dans Windows&reg; 8
