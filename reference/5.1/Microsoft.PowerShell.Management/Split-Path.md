...
* Les paramètres d’emplacement de fractionnement ( *qualifier* , *parent* , *feuille* et *NoQualifier* ) sont exclusifs. Autrement dit, vous ne pouvez utiliser qu’un seul de ces paramètres dans chaque commande.
