...
La commande utilise l' `Get-Process` applet de commande pour récupérer les processus MyApp sur les ordinateurs SERVEUR01 et Server02. Elle utilise un opérateur de pipeline pour envoyer les processus à l’applet de commande `Debug-Process` , qui attache les débogueurs.
