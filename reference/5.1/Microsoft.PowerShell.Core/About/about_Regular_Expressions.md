...
L’exemple suivant stocke les **SuccessAudit** les plus récents à partir du journal de sécurité Windows. L’expression régulière fournie extrait le nom d’utilisateur et le domaine du message et les stocke sous les clés : **N** pour le nom et **D** pour le domaine.
