...
- Si le suffixe de type est `u` et que la valeur peut être représentée par le type, `[int]` son type est `[int]` .
- Si le suffixe de type est `u` et que la valeur peut être représentée par le type, `[long]` son type est `[long]` .
