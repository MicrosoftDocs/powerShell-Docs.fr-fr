...
- L’emplacement de **ALLUSERS** est `$env:PROGRAMFILES\WindowsPowerShell\Modules` sur Windows.
...
Pour plus d’informations sur les composants logiciels enfichables PowerShell, consultez [about_Pssnapins](about_PSSnapins.md).
