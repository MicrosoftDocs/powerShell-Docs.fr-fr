...
- [ConvertFrom-String](xref:Microsoft.PowerShell.Utility.ConvertFrom-String): reposant sur [FlashExtract](https://www.microsoft.com/research/publication/flashextract-framework-data-extraction-examples), `ConvertFrom-String` crée des objets personnalisés à partir de données de chaîne structurées.
  Cette rubrique illustre et décrit chacune de ces méthodes.
