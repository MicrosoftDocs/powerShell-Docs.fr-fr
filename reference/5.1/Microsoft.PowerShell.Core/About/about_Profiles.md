...
|Utilisateur actuel, tous les ordinateurs hôtes   |$Home \\ [My] documents \\ WindowsPowerShell \\Profile.ps1 |
|Utilisateur actuel, hôte actuel|$Home \\ [My] documents \\ WindowsPowerShell\\<br>Microsoft.PowerShell_profile.ps1 |
...
En outre, d’autres programmes qui hébergent PowerShell peuvent prendre en charge leurs propres profils. Par exemple, l’environnement d’écriture de scripts intégré (ISE) de PowerShell prend en charge les profils spécifiques à l’hôte suivants.

|Description               | Path                                       |
|--------------------------|--------------------------------------------|
|Tous les utilisateurs, hôte actuel   |$PSHOME \\Microsoft.PowerShellISE_profile.ps1|
|Utilisateur actuel, hôte actuel|$Home \\ [My] documents \\ WindowsPowerShell\\<br>Microsoft.PowerShellISE_profile.ps1 |
