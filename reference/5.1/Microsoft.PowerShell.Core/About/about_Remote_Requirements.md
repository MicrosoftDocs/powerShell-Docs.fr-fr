...
Pour rechercher les applets de commande qui ont un paramètre ComputerName, mais n’utilisez pas la communication à distance Windows PowerShell, lisez la description du paramètre ComputerName des applets de commande.
