...
## Description
L’applet de commande **out-NULL** envoie sa sortie à null, en effet, en la supprimant du pipeline et en empêchant l’affichage de la sortie à l’écran. Cela affecte uniquement le flux de sortie standard.
Les autres flux de sortie, comme le flux d’erreur, ne sont pas affectés. Les exceptions seront affichées. Cela facilite le test de votre commande en cas d’erreur.
