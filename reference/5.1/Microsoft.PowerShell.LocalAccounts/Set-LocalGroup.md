...
## Description
L’applet de commande **Set-LocalGroup** modifie un groupe de sécurité local.

## EXEMPLES

### Exemple 1 : modifier la description d’un groupe

```
PS C:\> Set-LocalGroup -Name "SecurityGroup04" -Description "This is a sample description."
```

Cette commande modifie la description d’un groupe local.
...
### Description
Spécifie un commentaire pour le groupe.
...
### -InputObject
Spécifie le groupe de sécurité que cette applet de commande modifie.
...
### -Name
Spécifie le nom du groupe de sécurité que cette applet de commande modifie.
...
### -SID
Spécifie l’ID de sécurité (SID) du groupe de sécurité que cette applet de commande modifie.
