...
Vous pouvez choisir de définir uniquement une couleur de texte de premier plan. Par exemple, une couleur de texte de premier plan vert clair pour le jeton de **Commentaire** : `"Comment"="$([char]0x1b)[92m"` .
