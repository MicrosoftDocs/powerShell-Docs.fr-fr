...
## Description
L’applet **de commande New-DSCCheckSum** génère des fichiers de somme de contrôle pour les documents DSC (Desired State Configuration) Windows PowerShell et les ressources DSC compressées.
