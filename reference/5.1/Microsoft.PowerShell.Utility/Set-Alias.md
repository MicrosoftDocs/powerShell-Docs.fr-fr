...
Pour créer un alias, utilisez `Set-Alias` ou `New-Alias` . Pour supprimer un alias, utilisez l’applet de commande `Remove-Item` . Par exemple : `Remove-Item -Path Alias:aliasname`.
