...
`Tee-Object` utilise l’encodage « Unicode » (UTF-16LE) lorsqu’il écrit dans des fichiers. Si vous avez besoin d’un encodage différent, utilisez l' `Out-File` applet de commande avec le paramètre **Encoding** .
