...
## Description
L’applet de commande **New-alias** crée un alias dans la session Windows PowerShell active.
Les alias créés à l’aide de **New-alias** ne sont pas enregistrés quand vous quittez la session ou fermez Windows PowerShell.
