...
- Flux. Un flux de travail PowerShell. Pour plus d’informations, consultez [about_Workflows](../PSWorkflow/About/about_Workflows.md).
...
Spécifie le type de codage du fichier cible. La valeur par défaut est `UTF8`.
...
Pour plus d’informations, consultez `Import-Module` et [about_Pssnapins](../Microsoft.PowerShell.Core/About/about_PSSnapins.md).
