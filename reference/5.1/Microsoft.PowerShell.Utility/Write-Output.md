...
> [!IMPORTANT]
> Il y a un problème avec ce commutateur dans Windows PowerShell qui est résolu dans PowerShell 6,2 et versions ultérieures. Lors de l’utilisation de **noenumerate** et de l’utilisation explicite du paramètre **InputObject** , la commande est toujours énumérée. Pour contourner ce contournement, transmettez le ou les arguments **InputObject** à position positionnelle.
