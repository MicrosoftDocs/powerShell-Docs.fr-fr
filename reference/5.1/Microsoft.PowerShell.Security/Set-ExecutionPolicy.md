...
- Non **restreint** . charge tous les fichiers de configuration et exécute tous les scripts. Si vous exécutez un script non signé téléchargé à partir d'Internet, vous êtes invité à autoriser son exécution.
