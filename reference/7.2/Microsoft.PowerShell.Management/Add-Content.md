...
Ce paramètre a été introduit dans PowerShell 3,0.  À partir de PowerShell 7,2, `Add-Content` peut cibler des flux de données alternatifs sur des fichiers et des répertoires.
