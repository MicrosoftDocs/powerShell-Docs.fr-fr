...
Ce paramètre a été introduit dans Windows PowerShell 3.0. À compter de Windows PowerShell 7,2, `Remove-Item` peut supprimer d’autres flux de données des répertoires et des fichiers.
