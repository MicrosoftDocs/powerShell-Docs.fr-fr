...
Ce paramètre a été introduit dans PowerShell 3,0. À compter de PowerShell 7,2, `Set-Content` peut définir le contenu des flux de données alternatifs à partir des répertoires et des fichiers.
