...
Si vous envoyez plusieurs chaînes (un tableau de chaînes) à l' `-split` opérateur, la limite de la sous **-chaîne Max** est appliquée séparément à chaque chaîne.
...
L’instruction suivante fractionne une chaîne en trois sous-chaînes à partir de la fin de la chaîne.
