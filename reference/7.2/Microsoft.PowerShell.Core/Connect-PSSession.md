...
Indique que cette applet de commande utilise le protocole SSL (Secure Sockets Layer) (SSL) pour se connecter à la session déconnectée. Par défaut, SSL n'est pas utilisé.
