...
La commande **PSBreakpoint** est l’une des différentes applets de commande conçues pour déboguer les scripts et les commandes PowerShell. Pour plus d’informations sur le débogueur PowerShell, consultez about_Debuggers.
