...
Par défaut, `Import-PowerShellDataFile` seules les clés 500 sont importées à partir d’un `.psd1` fichier. Utilisez **SkipLimitCheck** pour importer plus de 500 clés.
