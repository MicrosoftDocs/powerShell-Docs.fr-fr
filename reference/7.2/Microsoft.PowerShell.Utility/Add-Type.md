...
> [!IMPORTANT]
> À partir de PowerShell 7,1, `ConsoleApplication` et ne `WindowsApplication` sont pas pris en charge et PowerShell lève une erreur de fin si l’un ou l’autre est spécifié en tant que valeurs pour le paramètre **OutputType** .
