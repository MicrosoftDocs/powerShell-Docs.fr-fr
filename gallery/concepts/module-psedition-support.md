...
> [!NOTE]
> Une fois qu’un manifeste de module est spécifié avec la clé CompatiblePSEditions ou s’il utilise la variable $PSEdition, il ne peut pas être importé sur des versions inférieures de PowerShell.
